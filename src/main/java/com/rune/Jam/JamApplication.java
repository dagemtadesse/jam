...
public class JamApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		var dagem = new User("Dagem Tadesse", "dagem", "dagem@gmail.com", "09", "student", User.Role.REGULAR);
		var naomi = new User("Naomi", "naomi", "naomi@gmail.com", "09", "student", User.Role.ADMIN);
		var yeabsra = new User("Yeabsra", "yeab", "yl@gmail.com", "09", "student", User.Role.REGULAR);
		var hela = new User("Helawit GebreEyesus", "g_sus", "yl@gmail.com", "09", "student", User.Role.REGULAR);
		var tsega = new User("tsega GebreEyesus", "tsi", "tsi@gmail.com", "09", "student", User.Role.ADMIN);
